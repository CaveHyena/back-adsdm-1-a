...
test("Deve retornar status 200 e um JSON no GET", async function () {
  ...
  test("Deve retornar status 404 e um JSON no no GET", async function () {
  ...
  test("Deve retornar status 422 sem conteudo no POST", async function () {
    const response = await request.post("/produtos");
    expect(response.status).toBe(422);
    expect(response.body).toEqual({});
  });

  test("Deve retornar status 200 e um JSON no POST", async function () {
    const response = await request
      .post("/produtos/1")
...
test("Deve retornar status 404 e um JSON no PUT", async function () {
  ...
  test("Deve retornar status 204 sem conteudo Delete", async function () {
